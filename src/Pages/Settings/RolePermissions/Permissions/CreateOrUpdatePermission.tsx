...
const CreateOrUpdatePermission: React.FC<Props> = () => {
    ...
    useEffect(() => {
        get('settings/role-permissions/permissions/create');
    }, []);
    ...
    return (
        <div>
            <div className="container mx-auto card shadow p-3">
                ...
                <form method='post' action={import.meta.env.VITE_APP_BASE_API + '/settings/role-permissions/permissions'} onSubmit={(e: any) => emitAutoPost(e)} className="flex justify-center">
